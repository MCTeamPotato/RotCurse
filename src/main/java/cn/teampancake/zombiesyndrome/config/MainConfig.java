...
public class MainConfig {
     ...
     **/
    public static final Supplier<ObjectOpenHashSet<MobEffect>> UNREMOVEABLE_EFFECTS = Suppliers.memoize(() -> UNREMOVEABLE_EFFECTS_LIST.get().stream().map(string -> ForgeRegistries.MOB_EFFECTS.getValue(new ResourceLocation(string))).collect(Collectors.toCollection(ObjectOpenHashSet::new)));
